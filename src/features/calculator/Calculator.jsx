...
export default function Calculator() {
  ...
  return (
    <div className="h-full flex flex-col justify-end p-6 max-w-md mx-auto pb-12">
      <div className="text-right text-7xl font-light mb-6 px-4 truncate">{state.display}</div>
      <div className="grid grid-cols-4 gap-4">
        <CalcButton label="AC" variant="func" onClick={() => dispatch({ type: 'CLEAR' })} />
        <div className="aspect-square bg-dark-muted rounded-full" /><div className="aspect-square bg-dark-muted rounded-full" />
