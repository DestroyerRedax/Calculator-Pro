...
export default function AgeCalculator() {
  ...
  return (
    <div className="h-full flex flex-col p-6 pt-24 justify-start space-y-8 bg-dark-bg">
      <div className="text-center"><h2 className="text-3xl font-bold text-white">Age Calculator</h2></div>
      ...
      <div className="grid grid-cols-3 gap-4">
        {[{ l: 'Years', v: age.y }, { l: 'Months', v: age.m }, { l: 'Days', v: age.d }].map(i => (
          <div key={i.l} className="bg-dark-surface p-5 rounded-[32px] text-center border border-white/5 shadow-xl">
            <div className="text-3xl font-black text-dark-accent">{i.v}</div>
            <div className="text-[10px] uppercase font-bold text-dark-muted mt-1">{i.l}</div>
          </div>
        ))}
      </div>
    </div>
