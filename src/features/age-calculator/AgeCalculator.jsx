...
export default function AgeCalculator() {
  ...
  return (
    <div className="h-full flex flex-col p-6 max-w-md mx-auto justify-center space-y-8">
      <div className="text-center pt-10"><h2 className="text-3xl font-bold text-white">Age Calculator</h2></div>
      ...
      <div className="grid grid-cols-3 gap-4">
        {[{ l: 'Years', v: age.y }, { l: 'Months', v: age.m }, { l: 'Days', v: age.d }].map(i => (
          <div key={i.l} className="bg-dark-surface p-4 rounded-3xl text-center border border-white/5">
            <div className="text-3xl font-bold text-dark-accent">{i.v}</div>
            <div className="text-[10px] uppercase text-dark-muted mt-1">{i.l}</div>
          </div>
        ))}
      </div>
    </div>
