...
export default function AgeCalculator() {
  ...
  return (
    <div className="h-full flex flex-col p-6 pt-24 justify-start space-y-8 bg-black">
      ...
      <div className="grid grid-cols-3 gap-4 max-w-sm mx-auto w-full">
        {[{ l: 'Years', v: age.y }, { l: 'Months', v: age.m }, { l: 'Days', v: age.d }].map(i => (
          <div key={i.l} className="bg-dark-surface p-5 rounded-[32px] text-center border border-white/5">
            <div className="text-3xl font-black text-dark-accent">{i.v}</div><div className="text-[10px] uppercase font-bold text-dark-muted mt-1">{i.l}</div>
          </div>
        ))}
      </div>
    </div>
